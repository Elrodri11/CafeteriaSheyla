                    ...
                    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar text-center border-end">
                        <div class="position-sticky h-100">
                            ...
                            <ul class="nav flex-column mt-5 mx-2">
                                ...
                                {{-- punto de venta --}}
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('pos*') ? 'active' : '' }}" href="{{ route('pos.index') }}">
                                        <i class="fa-solid fa-cash-register mx-2"></i>
                                        Punto de venta
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('menu*') ? 'active' : '' }}" href="{{ route('menu.index') }}">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('menu*') ? 'active' : '' }}" href="{{ route('nuevo.producto') }}">
                                        <i class="fa-solid fa-utensils mx-2"></i>
                                        Producto nuevo
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('inventario*') ? 'active' : '' }}" href="{{ route('inventario.index') }}">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('estadisticas*') ? 'active' : '' }}" href="{{ route('estadisticas.index') }}">
                                        <i class="fa-solid fa-chart-bar mx-2"></i>
                                        Estadísticas
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('caja*') ? 'active' : '' }}" href="{{ route('caja.index') }}">
                                        <i class="fa-solid fa-cash-register mx-2"></i>
                                        Caja
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('usuarios*') ? 'active' : '' }}" href="{{ route('usuarios.index') }}">
                                ...
                                @elseif (Auth::user()->rol == 'profesor')
                                    <li class="nav-item">
                                        <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('clases*') ? 'active' : '' }}" href="{{ route('clase.index') }}">
                                ...
                                @else
                                    <li class="nav-item">
                                        <a class="btn btn-outline-primary mb-2 w-100 fs-5 fw-semibold text-start border border-0 rounded-3 p-2 {{ request()->is('clases*') ? 'active' : '' }}" href="{{ route('claseAlumno.index') }}">
                                            <i class="fa-solid fa-user-tie mx-2"></i>
                                            Mis clases
                                        </a>
                                    </li>
