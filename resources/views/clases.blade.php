...
<div class="modal fade modal-lg" id="static-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="static-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="static-modalLabel">Agregar clase</h1>
        ...
        <div class="modal-body">
            <div class="row g-3">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control shadow-sm" id="materia" name="materia" value="{{ old('materia') }}">
                    @error('materia')
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control shadow-sm" id="aula" name="aula" value="{{ old('aula') }}">
                    @error('aula')
                        <p class="mt-2 text-danger fw-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control shadow-sm" id="created_at" name="created_at" value="{{ old('created_at') }}">
                    @error('created_at')
                        <p class="mt-2 text-danger fw-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control shadow-sm" id="fecha_final" name="fecha_final" value="{{ old('fecha_final') }}">
                    @error('fecha_final')
                        <p class="mt-2 text-danger fw-bold">{{ $message }}</p>
                    @enderror
                </div>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm start-time" name="Monday_inicio" id="Monday_inicio">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm end-time" name="Monday_termino" id="Monday_termino">
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                                    <option value="10:40">10:40</option>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm start-time" name="Tuesday_inicio" id="Tuesday_inicio">
                                    <option value="7:00">7:00</option>
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm end-time" name="Tuesday_termino" id="Tuesday_termino">
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                                    <option value="10:40">10:40</option>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm start-time" name="Wednesday_inicio" id="Wednesday_inicio">
                                    <option value="7:00">7:00</option>
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm end-time" name="Wednesday_termino" id="Wednesday_termino">
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                                    <option value="10:40">10:40</option>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm start-time" name="Thursday_inicio" id="Thursday_inicio">
                                    <option value="7:00">7:00</option>
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm end-time" name="Thursday_termino" id="Thursday_termino">
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                                    <option value="10:40">10:40</option>
                    ...
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm start-time" name="Friday_inicio" id="Friday_inicio">
                                    <option value="7:00">7:00</option>
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                            ...
                            <div>
                                ...
                                <select class="form-select shadow-sm end-time" name="Friday_termino" id="Friday_termino">
                                    <option value="7:55">7:55</option>
                                    <option value="8:50">8:50</option>
                                    <option value="9:45">9:45</option>
                                    <option value="10:40">10:40</option>
