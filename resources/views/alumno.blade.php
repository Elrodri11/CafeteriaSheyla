...
<div class="modal fade modal-lg" id="static-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="static-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action=" {{route('alumno.store')}} " novalidate>
            @csrf
        <div class="modal-content">
        <div class="modal-header">
            <h1 class="modal-title fs-5" id="static-modalLabel">Agregar alumno</h1>
        ...
        <div class="modal-body">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control shadow-sm" max="8" id="matricula" name="matricula" value="{{ old('matricula') }}">
                    @error('matricula')
                        <p class="mt-2 text-danger fw-bold">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control shadow-sm" max="8" id="uuid" name="uuid" value="{{ old('uuid') }}">
                ...
                <div class="col-md-4">
                    ...
                    <input type="password" class="form-control shadow-sm" id="pin_confirmation" name="pin_confirmation">
